...
//        //end*/
        ...
        vSeeds.push_back(CDNSSeedData("nodea.ducoin.com", "nodea.ducoin.com"));
        vSeeds.push_back(CDNSSeedData("nodeb.ducoin.com", "nodeb.ducoin.com"));
        vSeeds.push_back(CDNSSeedData("nodec.ducoin.com", "nodec.ducoin.com"));
       ...
       if (true && genesis.GetHash() != consensus.hashGenesisBlock)
		{
			...
			uint256 hashTarget = ~UINT256_ZERO >> 20;
			uint256 thash;
