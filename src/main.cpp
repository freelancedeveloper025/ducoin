...
const string strMessageMagic = "DUCOIN Signed Message:\n";
...
int GetLastPowBlock()
{
    ...
    } else if (LAST_POW_BLOCK == 0 && nBestHeight == 0)
    {
        LAST_POW_BLOCK= stepPOW_POS;
        LAST_POS_BLOCK= stepPOW_POS * 2;
        return LAST_POW_BLOCK;
    } else if (LAST_POW_BLOCK == 0 && nBestHeight != 0)
    {
        RColP = nBestHeight / (stepPOW_POS * 2);
        LAST_POW_BLOCK= (RColP * (stepPOW_POS * 2)) + stepPOW_POS;
        return LAST_POW_BLOCK;
    } else if (LAST_POW_BLOCK != 0 && nBestHeight != 0)
    {
        RColP = nBestHeight / (stepPOW_POS * 2);
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 58800000 * COIN; //1% premine
    }
