    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("DUCOIN") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a DUCOIN address"));
    ...
    aboutAction = new QAction(tr("&About DUCOIN"), this);
    aboutAction->setToolTip(tr("Show information about DUCOIN"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for DUCOIN"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("DUCOIN client") + QString(" ") + tr("[testnet]"));
...
//    trayIconMenu->>setStyleSheet("QWidget { background-repeat: no-repeat; background-image: url(:/images/bkg); border-color: red; }");
    ...
    trayIcon->setToolTip(tr("DUCOIN client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DUCOIN network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid DUCOIN address or malformed URI parameters."));
    }
